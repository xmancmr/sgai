...
const soilTypes = ['Argilo-calcaire', 'Volcanique', 'Sableux', 'Limono-argileux', 'Ferralitique', 'Tourbeux'];
const irrigationTypes = ['Goutte à goutte', 'Aspersion', 'Manuel', 'Submersion', 'Aucune'];
  ...
  const handleInputChange = (field: keyof ParcelData, value: string | number) => {
    ...
    setEditedParcel(prev => {
      ...
      if (field === 'coordinates') {
        return prev; // Géré par handleCoordinatesChange
      }
            ...
            <div className="border rounded-xl overflow-hidden h-full">
              ...
              <div className="p-4">
                <div className="h-[300px] rounded-lg mb-4">
                  {selectedParcel && (
                    <ParcelMap
                      coordinates={isEditMode && editedParcel ? editedParcel.coordinates : selectedParcel.coordinates}
                      parcelName={isEditMode && editedParcel ? editedParcel.name : selectedParcel.name}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                  ...
                  <div className="border rounded-lg p-4">
                    ...
                    {isEditMode ? (
                      <div className="space-y-3">
                        <div>
                          <label className="text-sm text-muted-foreground">Superficie (ha)</label>
                          <input 
                            type="number" 
