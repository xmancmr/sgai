...
import CultureIcon from '@/components/ui/culture-icon';
            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full p-2 border rounded focus:ring-2 focus:ring-agri-primary focus:border-agri-primary pl-10"
                >
                ...
                {newTask.culture && (
                  <div className="absolute left-3 top-1/2 transform -translate-y-1/2 pointer-events-none">
                    <CultureIcon cultureName={newTask.culture || ''} size={16} />
                  </div>
                )}
              </div>
            </div>
          ...
          <TableBody>
            {tasks.map((task) => (
              <TableRow key={task.id} className="hover:bg-muted/20 transition-colors">
                ...
                <TableCell>
                  <div className="flex items-center gap-2">
                    <CultureIcon cultureName={task.culture} size={16} />
                    <span>{task.culture}</span>
                  </div>
                </TableCell>
                <TableCell>
